 ...
 */
public class FileHandlerBetterImpl implements FileHandle {
    private String filename;
    private String charset;
    private BufferedReader bufferedReader = null;
    private BufferedWriter bufferedWriter = null;

    public FileHandlerBetterImpl(String fileName, String outFileName, String charSet) throws IOException {
